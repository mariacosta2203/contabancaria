...
// Classe abstrata +> Base para copiar outras Classes
public abstract class Conta {
	 ...
	 * Protected - Se estiverem dentro do mesmo packge podem acessar (telefone
	 * residencial, só as pessoas da minha casa podem usar) Public - Qualquer classe
	 * pode acessar (telefone público - orelhão) Default - Igual a protecd, mas ela
	 * depende de herança, então só atributos
	 */
